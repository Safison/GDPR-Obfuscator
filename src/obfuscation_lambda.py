from utils import parse_input_json, read_csv_from_s3, obfuscate_pii, write_obfuscated_file_to_s3
...
def lambda_handler(event, context):
    ...
    # It reads the CSV file, obfuscates sensitive data, and saves the obfuscated
...
if __name__ == "__main__": 
    lambda_handler({"file_to_obfuscate": "s3://ans-gdpr-bucket/students.csv",
        "pii_fields": ["name", "email_address"]}, None)